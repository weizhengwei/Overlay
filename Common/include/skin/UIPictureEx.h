//////////////////////////////////////////////////////////////////////
// PictureEx.cpp: implementation of the CUIPictureEx class.
//
...
// Copyright (c) 2001
//
// To use CUIPictureEx, follow these steps:
...
//   - in your dialog's header file replace CStatic with CUIPictureEx
//     (don't forget to #include "PictureEx.h" and add 
//     PictureEx.h and PictureEx.cpp to your project)
//   - call one of the overloaded CUIPictureEx::Load() functions somewhere
...
// CUIPictureEx, calling CPictureEx::Create (derived from CStatic), then 
// CUIPictureEx::Load and CUIPictureEx::Draw.
//
// By default, the control initializes its background to COLOR_3DFACE
// (see CUIPictureEx::PrepareDC()). You can change the background by
// calling CUIPictureEx::SetBkColor(COLORREF) after CUIPictureEx::Load().
//
...
// and an appropriate section in CUIPictureEx::Load(HGLOBAL, DWORD). These functions 
...
//                Now CUIPictureEx[Wnd] works in Win95 too.
...
class CUIPictureEx : public CStatic
{
public:
...
public:
	...
	CUIPictureEx();
	virtual ~CUIPictureEx();
	void Stop();   // stops animation
	void UnLoad();
	void _UnLoad(); // stops animation plus releases all resources
