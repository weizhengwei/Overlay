...
public:
	...
	void SetNormalClicked(BOOL bNormalClicked) {m_bNormalClicked = bNormalClicked ;} ;
	BOOL GetNormalClicked() const {return m_bNormalClicked ;} ;

	void SetFontWeight(LONG lWeight);
	BOOL GetFontWeigth() const {return m_lWeight ;} ;
...
protected:
	...
	BOOL     m_bNormalClicked ;                     // send message to parent window when this flag is on.
